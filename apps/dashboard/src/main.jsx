 ...
 return <div className="about">
  ...
  <motion.section {...secAnim} className="abSec abStory" id="story">
   <div className="abSecInner storyText">
    ...
    <motion.h3 className="storyLead" initial={{opacity:0,y:60}} whileInView={{opacity:1,y:0}} viewport={{once:false,amount:.3}} transition={{delay:.2,duration:.9,ease:[.22,1,.36,1]}}>I turn ideas into products that <em>feel fast</em> and <em>never break</em>.</motion.h3>
    <motion.p className="storySummary" initial={{opacity:0,y:40}} whileInView={{opacity:1,y:0}} viewport={{once:false,amount:.3}} transition={{delay:.3,duration:.9,ease:[.22,1,.36,1]}}>{p.summary}</motion.p>
    {(p.about||[]).map((a,i)=><motion.p className="storyMore" key={i} initial={{opacity:0,y:40}} whileInView={{opacity:1,y:0}} viewport={{once:false,amount:.3}} transition={{delay:.4+i*.15,duration:.9,ease:[.22,1,.36,1]}}>{a}</motion.p>)}
